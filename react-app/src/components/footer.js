  ...
  <div className="row mb-5">
    <div className="col-md-3">
      <div className="ftco-footer-widget mb-4">
        <h2 className="ftco-heading-2">MedicalAssistant.</h2>
      ...
      <div className="ftco-footer-widget mb-4">
        ...
        <div className="block-23 mb-3">
          <ul>
            ...
            <li><a href="ok"><span className="icon icon-envelope" /><span className="text"> MedicalAssistant.reply@gmail.com</span></a></li>
          </ul>
        </div>
      </div>
    </div>
